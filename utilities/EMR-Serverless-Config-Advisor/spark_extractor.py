        ...
        try:
            ...
            task_stage_output = {
                ...
                "shuffle_data_summary": (lambda sd: {
                    ...
                    "max_stage_disk_spill_gb": sd[6],
                    "peak_intermediate_data_gb": round(sd[4] + sd[6], 2),
                    "emr_serverless_storage_eligible": sd[4] + sd[6] <= 200,
                    "emr_serverless_storage_limit_gb": 200,
                    "note": "peak_intermediate_data_gb = max stage shuffle write + max stage disk spill (concurrent peak estimate)",
                })(
                    (lambda stages: (
                        ...
                        round(max((s.get("disk_spill_gb") or 0 for s in stages), default=0), 2),
                    ))(stage_details)
                ),
                "total_cost_factor": cost_factor,
