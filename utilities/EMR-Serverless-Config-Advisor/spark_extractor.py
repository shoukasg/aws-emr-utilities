        ...
        try:
            ...
            task_stage_output = {
                ...
                "shuffle_data_summary": (lambda stages: {
                    ...
                    "total_shuffle_write_gb": round(sum(s.get("shuffle_write_gb") or 0 for s in stages), 2),
                    "total_shuffle_read_gb": round(sum(s.get("shuffle_read_gb") or 0 for s in stages), 2),
                    "total_disk_spill_gb": round(sum(s.get("disk_spill_gb") or 0 for s in stages), 2),
